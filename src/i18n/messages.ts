export const messages = {
  ru: {
    ...
    auth: {
      account: 'Аккаунт Ion Pulse', loginTitle: 'Войти', registerTitle: 'Создать аккаунт',
      loginIntro: 'Рады видеть вас снова.', registerIntro: 'Публикуйте и обсуждайте игры на двух языках.',
      displayName: 'Имя пользователя', password: 'Пароль', pleaseWait: 'Подождите…',
      loginAction: 'Войти', registerAction: 'Зарегистрироваться', forgotPassword: 'Не помните пароль?',
      appeal: 'Обжаловать блокировку', hasAccount: 'Уже есть аккаунт? Войти', noAccount: 'Нет аккаунта? Создать',
      actionError: 'Не удалось выполнить действие', recovery: 'Восстановление доступа', recoveryTitle: 'Восстановить доступ',
      newPasswordTitle: 'Новый пароль', recoveryIntro: 'Введите email аккаунта. Мы отправим одноразовую ссылку, если адрес зарегистрирован.',
      newPasswordIntro: 'Задайте новый пароль. После сохранения потребуется войти заново на всех устройствах.',
    ...
    moderation: {
      eyebrow: 'Очередь модерации', title: 'Жалобы', reviewCount: '{count} требуют разбора', emptyReports: 'Открытых жалоб нет.', reportOn: 'Жалоба на {target}', publication: 'материал', comment: 'комментарий', decisionNote: 'Комментарий к решению', decisionNotePlaceholder: 'Объясните принятое решение', accept: 'Принять', dismiss: 'Отклонить', hideComment: 'Скрыть комментарий', suspendUntil: 'Заблокировать до', suspendAuthor: 'Временно заблокировать автора', appealsEyebrow: 'Обжалования санкций', appealsTitle: 'Обжалования', openCount: '{count} открытых', emptyAppeals: 'Открытых обращений нет.', appealDecisionReason: 'Причина решения', approveAppeal: 'Одобрить и снять блокировку', rejectAppeal: 'Отклонить', hiddenEyebrow: 'Скрытые комментарии', hiddenTitle: 'Скрытые комментарии', hiddenCount: '{count} скрыты', emptyHidden: 'Скрытых комментариев нет.', hiddenCommentFor: 'Скрыт комментарий к материалу {publication}', restoreComment: 'Восстановить комментарий',
      loadError: 'Не удалось загрузить жалобы', noteRequired: 'Добавьте комментарий к решению', saveError: 'Не удалось сохранить решение', appealNoteRequired: 'Добавьте причину решения по обращению', appealError: 'Не удалось рассмотреть обращение', commentHidden: 'Комментарий скрыт', hideError: 'Не удалось скрыть комментарий', commentRestored: 'Комментарий восстановлен', restoreError: 'Не удалось восстановить комментарий', suspensionDetailsRequired: 'Укажите комментарий к решению и срок блокировки', suspended: 'Участник временно заблокирован, его сессии отозваны', suspensionError: 'Не удалось применить санкцию',
    },
  },
  en: {
    navigation: {
    ...
    auth: {
      account: 'Ion Pulse account', loginTitle: 'Log in', registerTitle: 'Create an account',
      loginIntro: 'Welcome back.', registerIntro: 'Publish and discuss games in two languages.',
      displayName: 'Display name', password: 'Password', pleaseWait: 'Please wait…',
      loginAction: 'Log in', registerAction: 'Create account', forgotPassword: 'Forgot your password?',
      appeal: 'Appeal a suspension', hasAccount: 'Already have an account? Log in', noAccount: 'No account yet? Create one',
      actionError: 'Could not complete the action', recovery: 'Account recovery', recoveryTitle: 'Recover access',
      newPasswordTitle: 'New password', recoveryIntro: 'Enter your account email. We will send a one-time link if the address is registered.',
      newPasswordIntro: 'Set a new password. You will need to log in again on every device afterwards.',
    ...
    moderation: {
      eyebrow: 'Moderation queue', title: 'Reports', reviewCount: '{count} require review', emptyReports: 'There are no open reports.', reportOn: 'Report on {target}', publication: 'publication', comment: 'comment', decisionNote: 'Decision note', decisionNotePlaceholder: 'Explain the decision', accept: 'Accept', dismiss: 'Dismiss', hideComment: 'Hide comment', suspendUntil: 'Suspend until', suspendAuthor: 'Temporarily suspend author', appealsEyebrow: 'Sanction appeals', appealsTitle: 'Appeals', openCount: '{count} open', emptyAppeals: 'There are no open appeals.', appealDecisionReason: 'Decision reason', approveAppeal: 'Approve and lift suspension', rejectAppeal: 'Reject', hiddenEyebrow: 'Hidden comments', hiddenTitle: 'Hidden comments', hiddenCount: '{count} hidden', emptyHidden: 'There are no hidden comments.', hiddenCommentFor: 'Comment hidden for publication {publication}', restoreComment: 'Restore comment',
      loadError: 'Could not load reports', noteRequired: 'Add a note to the decision', saveError: 'Could not save the decision', appealNoteRequired: 'Add a reason for the appeal decision', appealError: 'Could not review appeal', commentHidden: 'Comment hidden', hideError: 'Could not hide comment', commentRestored: 'Comment restored', restoreError: 'Could not restore comment', suspensionDetailsRequired: 'Add a decision note and suspension end time', suspended: 'Member temporarily suspended and their sessions were revoked', suspensionError: 'Could not apply sanction',
    },
  },
} as const
